...
# --- 2. INICIALIZAÇÃO DOS ESTADOS DE SESSÃO (CRIA AS VARIÁVEIS ANTES DE USAR) ---
...
# --- 4. CSS ROBUSTO: LIMPA O TOPO E MANTÉM OS BOTÕES ---
if not st.session_state.usuario_logado or st.session_state.modulo == 'hub':
    st.markdown(f"""
    <style>
        /* Puxa o conteúdo para o topo absoluto, eliminando o bloco vazio */
        .block-container {{
            padding-top: 0rem !important;
            padding-bottom: 0rem !important;
            margin-top: -5rem !important;
        }}
        /* Remove a decoração superior (elipse/linha) */
        [data-testid="stDecoration"] {{ display: none !important; }}
        /* Remove controles de interface (setinha, menu, sidebar) */
        [data-testid="collapsedControl"], [data-testid="stSidebar"], [data-testid="stHeader"], footer {{
            display: none !important;
        }}
        /* Define a cor de fundo do portal */
